 ...
 * EXACT COPY of Alpine.js cleanWordHtml() function
 * Cleans Word/Office pasted content for consistent rendering
 */

/**
 * Clean HTML pasted from Microsoft Word
 * Removes VML, MSO styles, and applies beautiful table/list styles
