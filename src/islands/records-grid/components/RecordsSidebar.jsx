/**
 * RecordsSidebar - React sidebar for records grid
 * Pixel-perfect conversion of the EJS sidebar from view-table-progressive.ejs
 */
                ...
                <div className="flex h-full flex-col pb-16" style={{ position: 'relative' }}>
                    <div className="relative -mr-3.5 h-full grow pr-3.5 overflow-auto">
                        <div className="space-y-1">
                            <button type="button"
                                className={`flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary ${selectedTab === 'all' ? 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]' : ''}`}
                                ...
                                <div className="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" strokeWidth="1.5"></path>
                                        <path d="M8 13H10.5" stroke="currentColor" strokeWidth="1.5"
                                            strokeLinecap="round"></path>
                                        <path d="M8 9H14.5" stroke="currentColor" strokeWidth="1.5"
                                            strokeLinecap="round"></path>
                                        <path d="M8 17H9.5" stroke="currentColor" strokeWidth="1.5"
                                            strokeLinecap="round"></path>
                                        <path opacity="0.5"
                            ...
                            <button type="button"
                                className={`flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary ${selectedTab === 'fav' ? 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]' : ''}`}
                            ...
                            <div className="flex flex-wrap gap-1">
                                <button type="button"
                                    className={`badge badge-outline-primary mb-0 py-0 px-2 uppercase cursor-pointer transition-all ${selectedTab === 'personal' ? 'bg-primary/10' : 'hover:bg-primary/5'}`}
                                    onClick={() => setSelectedTab('personal')}>
                                    Personal
                                </button>
                                <button type="button"
                                    className={`badge badge-outline-warning mb-0 py-0 px-2 uppercase cursor-pointer transition-all ${selectedTab === 'work' ? 'bg-warning/10' : 'hover:bg-warning/5'}`}
                                    onClick={() => setSelectedTab('work')}>
                                    Work
                                </button>
                                <button type="button"
                                    className={`badge badge-outline-info mb-0 py-0 px-2 uppercase cursor-pointer transition-all ${selectedTab === 'social' ? 'bg-info/10' : 'hover:bg-info/5'}`}
                                    onClick={() => setSelectedTab('social')}>
                                    Social
                                </button>
                                <button type="button"
                                    className={`badge badge-outline-danger mb-0 py-0 px-2 uppercase cursor-pointer transition-all ${selectedTab === 'important' ? 'bg-danger/10' : 'hover:bg-danger/5'}`}
