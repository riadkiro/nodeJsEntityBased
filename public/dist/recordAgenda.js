...
`}function se({events:u,entityData:C,onEventClick:h,onDeleteEvent:m,getStatusInfo:v,getCustomFieldValue:l}){const[E,A]=o.useState("date"),[S,$]=o.useState("asc"),a=o.useMemo(()=>[...u].sort((r,j)=>{let s,t;switch(E){case"title":return s=(r.title||"").toLowerCase(),t=(j.title||"").toLowerCase(),S==="asc"?s.localeCompare(t):t.localeCompare(s);case"status":return s=v(r).label,t=v(j).label,S==="asc"?s.localeCompare(t):t.localeCompare(s);case"type":return s=l(r,"type_evenement")||"",t=l(j,"type_evenement")||"",S==="asc"?s.localeCompare(t):t.localeCompare(s);case"date":default:return s=r.date?new Date(r.date).getTime():0,t=j.date?new Date(j.date).getTime():0,S==="asc"?s-t:t-s}}),[u,E,S,v,l]),c=r=>{E===r?$(j=>j==="asc"?"desc":"asc"):(A(r),$("asc"))},i=r=>r?new Date(r).toLocaleDateString("fr-FR",{day:"2-digit",month:"short",year:"numeric"}):"—",g=r=>r?new Date(r).toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit",hour12:!1}):"",x=r=>r&&new Date(r)<new Date,k=({field:r})=>e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 10 10",fill:"none",style:{opacity:E===r?1:.3},children:e.jsx("path",{d:E===r&&S==="desc"?"M5 2L8 6H2L5 2Z":"M5 8L2 4H8L5 8Z",fill:"currentColor"})});return u.length===0?null:e.jsxs("div",{className:"ra-list-wrap",children:[e.jsx("style",{children:de()}),e.jsxs("table",{className:"ra-list-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsxs("th",{className:"ra-th ra-th-sortable",onClick:()=>c("title"),children:["Titre ",e.jsx(k,{field:"title"})]}),e.jsxs("th",{className:"ra-th ra-th-sortable",onClick:()=>c("date"),children:["Date ",e.jsx(k,{field:"date"})]}),e.jsx("th",{className:"ra-th",children:"Heure"}),e.jsx("th",{className:"ra-th",children:"Durée"}),e.jsxs("th",{className:"ra-th ra-th-sortable",onClick:()=>c("type"),children:["Type ",e.jsx(k,{field:"type"})]}),e.jsx("th",{className:"ra-th",children:"Lieu"}),e.jsxs("th",{className:"ra-th ra-th-sortable",onClick:()=>c("status"),children:["Statut ",e.jsx(k,{field:"status"})]}),e.jsx("th",{className:"ra-th",style:{width:40}})]})}),e.jsx("tbody",{children:a.map((r,j)=>{var z;const s=v(r),t=l(r,"type_evenement"),T=l(r,"lieu_evenement"),D=l(r,"duree_evenement"),I=x(r.date);return e.jsxs("tr",{className:`ra-tr ${I?"past":""}`,onClick:()=>h(r),style:{animationDelay:`${j*30}ms`},children:[e.jsxs("td",{className:"ra-td ra-td-title",children:[e.jsx("div",{className:"ra-td-title-dot",style:{background:s.color}}),r.title||"Sans titre"]}),e.jsx("td",{className:"ra-td",children:i(r.date)}),e.jsx("td",{className:"ra-td ra-td-time",children:g(r.date)}),e.jsx("td",{className:"ra-td",children:D?`${D} min`:"—"}),e.jsx("td",{className:"ra-td ra-td-type",children:t?e.jsx("span",{className:"ra-td-type-badge",children:t.charAt(0).toUpperCase()+t.slice(1)}):"—"}),e.jsx("td",{className:"ra-td",children:T||"—"}),e.jsx("td",{className:"ra-td",children:e.jsx("span",{className:"ra-td-status",style:{background:`${s.color}12`,color:s.color},children:s.label})}),e.jsx("td",{className:"ra-td ra-td-actions",children:e.jsx("button",{className:"ra-td-delete",onClick:b=>{var _;b.stopPropagation(),m((_=r._id)==null?void 0:_.toString())},title:"Supprimer",children:e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("polyline",{points:"3 6 5 6 21 6"}),e.jsx("path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})]})})})]},(z=r._id)==null?void 0:z.toString())})})]})]})}function de(){return`
.ra-list-wrap {
...
`}function ce({accountNumber:u,recordId:C,entitySlug:h}){const[m,v]=o.useState([]),[l,E]=o.useState(null),[A,S]=o.useState(!0),[$,a]=o.useState(!1),[c,i]=o.useState("calendar"),[g,x]=o.useState("dayGridMonth"),[k,r]=o.useState(!1),[j,s]=o.useState(null),[t,T]=o.useState(null),D=o.useRef(null),I=o.useRef(null),z=`agenda-${C}`,b=`/account/${u}/api/records/${C}/events`,_=`/account/${u}/api/user/view-preferences`;o.useEffect(()=>{(async()=>{var n;try{const y=await(await fetch(`${_}/${z}`,{credentials:"include"})).json();if(y.success&&((n=y.preferences)!=null&&n.agendaPrefs)){const N=y.preferences.agendaPrefs;N.viewMode&&i(N.viewMode),N.calendarView&&x(N.calendarView)}}catch{}a(!0)})()},[_,z]);const M=o.useCallback(async n=>{try{const p={viewMode:c,calendarView:g,...n};await fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({viewId:z,preferences:{agendaPrefs:p}})})}catch(p){console.warn("[RecordAgenda] Prefs save error:",p)}},[_,z,c,g]),B=o.useCallback(n=>{i(n),M({viewMode:n})},[M]),R=o.useCallback((n,p)=>{if(!n||!l)return null;const y=(l.customFields||[]).find(f=>f.name===p);if(!y)return null;const N=(n.customFields||[]).find(f=>{var w,O;const d=((w=f.field_id)==null?void 0:w._id)||f.field_id;return(d==null?void 0:d.toString())===((O=y._id)==null?void 0:O.toString())});return(N==null?void 0:N.value)||null},[l]),F=o.useCallback(n=>{if(!n||!(l!=null&&l.statusClassification))return{label:"Planifié",color:"#3b82f6"};const p=l.statusClassification,y=(n.classificationValues||[]).find(f=>{var d,w;return((d=f.classificationId)==null?void 0:d.toString())===((w=p._id)==null?void 0:w.toString())});if(!y)return{label:"Planifié",color:"#3b82f6"};const N=(p.options||[]).find(f=>{var d,w;return((d=f._id)==null?void 0:d.toString())===((w=y.optionId)==null?void 0:w.toString())});return N?{label:N.label,color:N.color||"#3b82f6"}:{label:"Planifié",color:"#3b82f6"}},[l]),U=o.useMemo(()=>m.map(n=>{var L;const p=F(n),y=R(n,"duree_evenement"),N=R(n,"lieu_evenement"),f=R(n,"type_evenement"),d=R(n,"notes_evenement");let w=n.date?new Date(n.date):new Date,O=n.end_date?new Date(n.end_date):null;return!O&&y?O=new Date(w.getTime()+(parseInt(y)||30)*6e4):O||(O=new Date(w.getTime()+30*6e4)),{id:(L=n._id)==null?void 0:L.toString(),title:n.title||"Sans titre",start:w.toISOString(),end:O.toISOString(),backgroundColor:p.color,borderColor:p.color,textColor:"#fff",extendedProps:{_raw:n,status:p.label,statusColor:p.color,duration:y,lieu:N,type:f,notes:d}}}),[m,F,R]),P=o.useCallback(async()=>{try{const p=await(await fetch(b,{credentials:"include"})).json();p.success&&(v(p.events||[]),E(p.entityData||null))}catch(n){console.error("[RecordAgenda] Fetch error:",n)}S(!1)},[b]);o.useEffect(()=>{P()},[P]);const W=o.useRef(g);W.current=g,o.useEffect(()=>{var N;if(c!=="calendar"||A||!$||!D.current)return;if(typeof FullCalendar>"u"){console.error("[RecordAgenda] FullCalendar not loaded");return}const n=(N=I.current)==null?void 0:N.getDate();I.current&&I.current.destroy();let p=!1;const y=new FullCalendar.Calendar(D.current,{initialView:W.current,initialDate:n||void 0,locale:"fr",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay"},buttonText:{today:"Aujourd'hui",month:"Mois",week:"Semaine",day:"Jour"},editable:!0,dayMaxEvents:3,selectable:!0,droppable:!1,nowIndicator:!0,slotMinTime:"07:00:00",slotMaxTime:"21:00:00",slotDuration:"00:15:00",snapDuration:"00:05:00",allDaySlot:!1,height:"100%",expandRows:!0,eventTimeFormat:{hour:"2-digit",minute:"2-digit",meridiem:!1,hour12:!1},events:U,datesSet:f=>{if(!p)return;const d=f.view.type;d!==W.current&&(W.current=d,x(d),fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({viewId:z,preferences:{agendaPrefs:{viewMode:"calendar",calendarView:d}}})}).catch(()=>{}))},eventClick:f=>{const d=f.event.extendedProps._raw;s(d),r(!0)},dateClick:f=>{const d=new Date(f.dateStr);d.setMinutes(Math.round(d.getMinutes()/5)*5,0,0),T(d.toISOString()),s(null),r(!0)},eventDrop:async f=>{var L,V;const d=f.event.id,w=(L=f.event.start)==null?void 0:L.toISOString(),O=(V=f.event.end)==null?void 0:V.toISOString();try{await fetch(`${b}/${d}/drag`,{method:"PATCH",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({newStart:w,newEnd:O})}),await P()}catch(Y){console.error("[RecordAgenda] Drag error:",Y),f.revert()}},eventResize:async f=>{var L,V;const d=f.event.id,w=(L=f.event.start)==null?void 0:L.toISOString(),O=(V=f.event.end)==null?void 0:V.toISOString();try{await fetch(`${b}/${d}/drag`,{method:"PATCH",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({newStart:w,newEnd:O})}),await P()}catch(Y){console.error("[RecordAgenda] Resize error:",Y),f.revert()}},eventDidMount:f=>{const d=f.event.extendedProps;let w=f.event.title;d.lieu&&(w+=`
📍 ${d.lieu}`),d.status&&(w+=`
● ${d.status}`),f.el.title=w}});return y.render(),I.current=y,requestAnimationFrame(()=>{p=!0}),()=>{I.current&&(I.current.destroy(),I.current=null)}},[c,A,$,U,b,P,_,z]);const Z=o.useCallback(async n=>{try{(await(await fetch(b,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(n)})).json()).success&&(await P(),r(!1),s(null),T(null))}catch(p){console.error("[RecordAgenda] Create error:",p)}},[b,P]),X=o.useCallback(async(n,p)=>{try{(await(await fetch(`${b}/${n}`,{method:"PATCH",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(p)})).json()).success&&(await P(),r(!1),s(null))}catch(y){console.error("[RecordAgenda] Update error:",y)}},[b,P]),J=o.useCallback(async n=>{if(confirm("Supprimer cet événement ?"))try{(await(await fetch(`${b}/${n}`,{method:"DELETE",credentials:"include"})).json()).success&&(await P(),r(!1),s(null))}catch(p){console.error("[RecordAgenda] Delete error:",p)}},[b,P]),G=o.useCallback(()=>{s(null),T(null),r(!0)},[]),K=o.useCallback(n=>{s(n),r(!0)},[]);return A||!$?e.jsxs("div",{className:"ra-loading",children:[e.jsx("div",{className:"ra-spinner"}),e.jsx("span",{children:"Chargement de l'agenda..."})]}):e.jsxs("div",{className:"ra-container",children:[e.jsx("style",{children:pe()}),e.jsx(te,{viewMode:c,onViewChange:B,onNewEvent:G,eventCount:m.length}),c==="calendar"&&e.jsx("div",{className:"ra-calendar-wrap",children:e.jsx("div",{ref:D,className:"ra-calendar"})}),c==="timeline"&&e.jsx(le,{events:m,entityData:l,onEventClick:K,getStatusInfo:F,getCustomFieldValue:R}),c==="list"&&e.jsx(se,{events:m,entityData:l,onEventClick:K,onDeleteEvent:J,getStatusInfo:F,getCustomFieldValue:R}),m.length===0&&!A&&e.jsxs("div",{className:"ra-empty",children:[e.jsx("div",{className:"ra-empty-icon",children:e.jsxs("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2",ry:"2"}),e.jsx("line",{x1:"16",y1:"2",x2:"16",y2:"6"}),e.jsx("line",{x1:"8",y1:"2",x2:"8",y2:"6"}),e.jsx("line",{x1:"3",y1:"10",x2:"21",y2:"10"}),e.jsx("line",{x1:"10",y1:"14",x2:"14",y2:"18"}),e.jsx("line",{x1:"14",y1:"14",x2:"10",y2:"18"})]})}),e.jsx("h3",{children:"Aucun événement"}),e.jsx("p",{children:"Ajoutez votre premier événement pour commencer à organiser votre agenda."}),e.jsxs("button",{className:"ra-empty-btn",onClick:G,children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),e.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),"Nouvel événement"]})]}),e.jsx(ne,{isOpen:k,onClose:()=>{r(!1),s(null),T(null)},event:j,entityData:l,prefillDate:t,onCreate:Z,onUpdate:X,onDelete:J,getCustomFieldValue:R,getStatusInfo:F})]})}function pe(){return`
...
`}function q(){document.querySelectorAll('[data-island="record-agenda"]').forEach(u=>{if(u.dataset.mounted==="1")return;u.dataset.mounted="1";const C={accountNumber:u.dataset.accountNumber,recordId:u.dataset.recordId,entitySlug:u.dataset.entitySlug};console.log("[RecordAgenda Island] Mounting:",C),Q(u).render(e.jsx(ee.StrictMode,{children:e.jsx(ce,{...C})}))})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",q):q();
