...
function GalleryPanel({ accountNumber: accountNumberProp, doc }) {
    ...
    const placeholderHtml = `<span class="doc-image-placeholder" contenteditable="false" data-image-placeholder="1" style="width:320px;height:190px;overflow:hidden;display:inline-flex;align-items:center;justify-content:center;vertical-align:top;border:0;border-radius:8px;background-color:#f8fafc;background-image:${placeholderBg};background-size:cover;background-position:center;margin:12px 8px;cursor:pointer;box-sizing:border-box;position:relative;resize:none;"></span>`
